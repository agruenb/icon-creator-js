...
/**
 * A marker is a UI element used for indicating interaction locations for the user. 
 * After creation the HTML element can be accessed on marker.container.
 */
export default class Marker extends HelperPattern {
    ...
    constructor(viewportElement: HTMLElement, x: number, y: number, memorize: string, icon: string = "empty", rotation: number = 0, scale: number = 1) {
    ...
    /**
     * Updates the container position and transformation based on the current coordinates and rotation.
     */
